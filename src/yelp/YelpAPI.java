...
public class YelpAPI {
	//this is used for 1. get the obtainAccessToken, Token is used as a code.
	//searchForBusinessesByLocation   servlet call it.
	//
	...
	private JSONObject obtainAccessToken() {
		try {
			...
			//getOutputStream is used for request to the server
			//getInput is used for get the information from server.
			
			DataOutputStream wr = new DataOutputStream(connection.getOutputStream());  
			wr.write(query.getBytes());
			//get response from yelp.
			//and change it into JSON format.
