...
public class MongoDBImport {
	public static void main(String[] args) throws ParseException {
		MongoClient mongoClient = new MongoClient();//create a new object of MongoDB
		MongoDatabase db = mongoClient.getDatabase(DBUtil.DB_NAME); //get from DBUtil
		db.getCollection("users").insertOne(//get a fake user
				new Document()
		...
		db.getCollection("users").createIndex(new Document("user_id", 1), indexOptions);//1:asceding order
