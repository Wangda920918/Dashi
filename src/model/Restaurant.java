...
public class Restaurant {
	//this class is used to manage the data from yelp and change JSON into JAVA object.
	...
	public static String parseString(String str) {// categories : there may be
													// some "abc"abc"".

		return str.replace("\"", "\\\"").replace("/", " or ");// want chage " to
																// \"
		// so """ --> "\"" -----> "\"" -->"\\\""
		// String s = "coffee\"bar" -->coffee"bar
	}

	public static String jsonArrayToString(JSONArray array) {// JSON array to
																// string
	...
	public static JSONArray stringToJSONArray(String str) {// string to JSON
															// because if you want connect with frontend
															//frontend don't know java, it should use JSON
		try {
